...
from tests.support import AppTest, make_wav, silence, tone
...
class Transcriber(AppTest):
    ...
    def setUp(self):
        ...
        self.conf = self.config(
            cleanup_provider="openrouter", openrouter_api_key="sk-or-test")
