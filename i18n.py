...
TR = {
    ...
    "Quit": "Çık",
    "Reisülküttab: ready": "Reisülküttab: hazır",
    "Reisülküttab: recording": "Reisülküttab: kaydediyor",
    "Reisülküttab: working": "Reisülküttab: işleniyor",
    ...
    "Cleanup failed; raw text was used: {error}":
        "Temizleme başarısız; ham metin kullanıldı: {error}",
    "Reisülküttab: cleanup failed": "Reisülküttab: temizleme başarısız",
    "Pasted, but clipboard restore failed: {error}":
        "Yapıştırıldı, ancak önceki pano geri yüklenemedi: {error}",
    "Reisülküttab: clipboard restore failed": "Reisülküttab: pano geri yüklenemedi",
    ...
    "macOS has not been told to let Reisülküttab press keys. Turn Reisülküttab on under "
    "System Settings → Privacy & Security → Accessibility.":
        "macOS, Reisülküttab'nin tuşlara basmasına henüz izin vermiyor. Sistem Ayarları "
        "→ Gizlilik ve Güvenlik → Erişilebilirlik altında Reisülküttab'yi aç.",
    ...
    "Reisülküttab Settings": "Reisülküttab Ayarları",
    "General": "Genel",
    ...
    "Turkish": "Türkçe",
    "English": "İngilizce",
    "Restart Reisülküttab for the language change to reach every window.":
        "Dil değişikliğinin her pencereye işlemesi için Reisülküttab'yi yeniden başlat.",
    "Microphone": "Mikrofon",
    ...
    "Reisülküttab asks macOS for these combinations itself, while it is running. "
    "Nothing is installed, and no other application receives them in the "
    "meantime.":
        "Reisülküttab bu kombinasyonları çalışırken macOS'tan kendisi ister. Hiçbir şey "
        "kurulmaz ve o sırada başka hiçbir uygulama bu tuşları almaz.",
    "Reisülküttab listens for these combinations while it is running. Nothing is "
    "installed, and the shortcut keys are not typed into the focused application.":
        "Reisülküttab çalışırken bu kombinasyonları dinler. Hiçbir şey kurulmaz ve "
        "kısayol tuşları odaktaki uygulamaya yazılmaz.",
    "Active while Reisülküttab is running.": "Reisülküttab çalışırken etkin.",
    ...
    "Shortcut saved: {shortcut}\nReisülküttab holds this one itself while it is "
    "running, so it works as soon as the settings are saved.":
        "Kısayol kaydedildi: {shortcut}\nReisülküttab bunu çalıştığı sürece kendisi "
    ...
    "macOS would not give Reisülküttab {shortcut}; another application already holds it.":
        "macOS {shortcut} kombinasyonunu Reisülküttab'ye vermedi; başka bir uygulama "
    ...
    "Reisülküttab: talking to Claude": "Reisülküttab: ajanla konuşuyor",
    "Reisülküttab: recording for Claude": "Reisülküttab: ajan için kaydediyor",
    "Asking {name}…": "{name} soruluyor…",
    "{name}: {preview}": "{name}: {preview}",
    "{name} answered, but: {error}": "{name} cevapladı, ama: {error}",
    "Reisülküttab: {name} could not do all of it": "Reisülküttab: {name} her şeyi yapamadı",
    ...
    "Reisülküttab: in a meeting": "Reisülküttab: toplantıda",
    "Reisülküttab: in a meeting ({time})": "Reisülküttab: toplantıda ({time})",
    "Reisülküttab: writing the meeting up": "Reisülküttab: tutanak çıkarıyor",
    "Meeting recorded, writing it up…": "Toplantı kaydedildi, tutanak çıkarılıyor…",
    "Meeting written up: {title}": "Tutanak hazır: {title}",
    "Reisülküttab: the meeting is written up": "Reisülküttab: tutanak hazır",
    "Meeting failed: {error}": "Toplantı başarısız: {error}",
    "Reisülküttab: the meeting could not be written up": "Reisülküttab: tutanak çıkarılamadı",
    ...
    "speaking, because the two never share a channel.":
        ...
        "aynı kanala girmez.",
    "Sound": "Ses",
    "Same as dictation": "Reisülküttabdekiyle aynı",
